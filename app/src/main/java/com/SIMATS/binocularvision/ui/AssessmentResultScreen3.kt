            ...
            Surface(
                ...
                Column(
                    ...
                    val (label, statusColor, statusBgColor, description, icon) = when (rawClassification) {
                        "normal" -> Quintuple("Normal Vision", Color(0xFF10B981), Color(0xFFECFDF5), "Your eye movement control is within normal limits.", Icons.Default.Check)
                        "mild issue" -> Quintuple("Mild Issue", Color(0xFFF59E0B), Color(0xFFFFFBEB), "Minor delay observed during rapid eye movements.", Icons.Default.Info)
                        else -> Quintuple("Needs Attention", Color(0xFFEF4444), Color(0xFFFEF2F2), "Reduced eye movement control detected.", Icons.Default.Warning)
                    }
